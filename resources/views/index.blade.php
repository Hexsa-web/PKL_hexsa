...
@section('content')
                                ...
                                <div class="grid__wraper">
                                    <div class="grid__wraper__img">
                                        ...
                                        <div class="grid__wraper__icon">
                                            <ul>
                                                <li>
                                                    <span data-bs-toggle="modal" data-bs-target="#3product-{{$data->slug}}">
                     ...
                     <div class="row">
                         <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                             <div class="grid__wraper">
                                 ...
                                 <div class="grid__wraper__info">
                                     <h3 class="grid__wraper__tittle">
                                         <a href="/prodict/{{ $data->slug }}" tabindex="0">{{$data->name}}</a>
                                     </h3>
                                     <div class="grid__wraper__price">
    ...
    @foreach($product as $data)
        <div class="grid__quick__view__modal modalarea modal fade" id="3product-{{$data->slug}}" tabindex="-1" aria-labelledby="exampleModal" aria-hidden="true">
