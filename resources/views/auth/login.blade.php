     ...
     <div class="container">
        <div class="row">
            <div class="col-xl-8 offset-md-2 loginarea__col">
                <ul class="nav  tab_button_wrap text-center" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="single_tablink active" data-bs-toggle="tab" data-bs-target="#projects_one" type="button">Login</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="single_tablink" data-bs-toggle="tab" data-bs-target="#projects_two" type="button">Sing up</button>
                    </li>
            ...
            <div class="tab-content tab_content_wrapper" id="myTabContent">
                        ...
                        <div class="loginarea__wraper">
                            ...
                            <form method="post" action="{{ route('login')}}">
                                ...
                                <div class="loginarea__form">
                                    ...
                                    <input class="common_login_input" type="text" name="email" type="email" placeholder="Your Email">

                                </div>
                                <div class="loginarea__form">
                                    <label class="form__label">Password</label>
                                    <input class="common_login_input" type="password" name="password" type="password" placeholder="Password">
                            ...
                            <div class="loginarea_social_option">
                              
                                <ul class="loginarea_social_btn">
                ...
                <div class="tab-pane fade" id="projects_two" role="tabpanel" aria-labelledby="projects_two">
                    <div class="col-xl-8 offset-md-2 loginarea__col">
                        <div class="loginarea__wraper">
                            <div class="loginarea__heading">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="loginarea__form">
                                            ...
                                            <input class="common_login_input" name="name" type="text" placeholder="Your Name">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="loginarea__form">
                                            <label class="form__label">Email</label>
                                            <input class="common_login_input" name="email" type="email" placeholder="Your Email">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="loginarea__form">
                                            <label class="form__label">Password</label>
                                            <input class="common_login_input" name="password" type="password" placeholder="Password">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="loginarea__form">
                                            ...
                                            <input class="common_login_input" name="password" type="password" type="password" placeholder="Confirm Password">
