                                            ...
                                            <div class="grid__wraper__img">
                                                <div class="grid__wraper__img__inner">
                                                    <a href="single-product.html">
                                                        <img class="primary__image" src="{{asset('assets/frontendimg/grid/grid__1.png" alt="Primary Image">
                                                        <img class="secondary__image" src="{{asset('assets/frontendimg/grid/grid__2.png" alt="Secondary Image">
                                                    </a>
                                                </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-6">
                                        <div class="grid__wraper">
                                            <div class="grid__wraper__img">
                                                <div class="grid__wraper__img__inner">
                                                    <a href="single-product.html">
                                                        <img class="primary__image" src="{{asset('assets/frontendimg/grid/grid__3.png" alt="Primary Image">
                                                        <img class="secondary__image" src="{{asset('assets/frontendimg/grid/grid__4.png" alt="Secondary Image">
                                                    </a>
                                                </div>
                                                <div class="grid__wraper__icon">                                
                                                    <ul>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-6">
                                        <div class="grid__wraper">
                                            <div class="grid__wraper__img">
                                                <div class="grid__wraper__img__inner">
                                                    <a href="single-product.html">
                                                        <img class="primary__image" src="{{asset('assets/frontendimg/grid/grid__5.png" alt="Primary Image">
                                                        <img class="secondary__image" src="{{asset('assets/frontendimg/grid/grid__6.png" alt="Secondary Image">
                                                    </a>
                                                </div>
                                                <div class="grid__wraper__icon">                                
                                                    <ul>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-6">
                                        <div class="grid__wraper">
                                            <div class="grid__wraper__img">
                                                <div class="grid__wraper__img__inner">
                                                    <a href="single-product.html">
                                                        <img class="primary__image" src="{{asset('assets/frontendimg/grid/grid__7.png" alt="Primary Image">
                                                        <img class="secondary__image" src="{{asset('assets/frontendimg/grid/grid__8.png" alt="Secondary Image">
                                                    </a>
                                                </div>
                                                <div class="grid__wraper__icon">                                
                                                    <ul>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-6">
                                        <div class="grid__wraper">
                                            <div class="grid__wraper__img">
                                                <div class="grid__wraper__img__inner">
                                                    <a href="single-product.html">
                                                        <img class="primary__image" src="{{asset('assets/frontendimg/grid/grid__9.png" alt="Primary Image">
                                                        <img class="secondary__image" src="{{asset('assets/frontendimg/grid/grid__10.png" alt="Secondary Image">
                                                    </a>
                                                </div>
                                                <div class="grid__wraper__icon">                                
                                                    <ul>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-6">
                                        <div class="grid__wraper">
                                            <div class="grid__wraper__img">
                                                <div class="grid__wraper__img__inner">
                                                    <a href="single-product.html">
                                                        <img class="primary__image" src="{{asset('assets/frontendimg/grid/grid__11.png" alt="Primary Image">
                                                        <img class="secondary__image" src="{{asset('assets/frontendimg/grid/grid__12.png" alt="Secondary Image">
                                                    </a>
                                                </div>
                                                <div class="grid__wraper__icon">                                
                                                    <ul>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-6">
                                        <div class="grid__wraper">
                                            <div class="grid__wraper__img">
                                                <div class="grid__wraper__img__inner">
                                                    <a href="single-product.html">
                                                        <img class="primary__image" src="{{asset('assets/frontendimg/grid/grid__14.png" alt="Primary Image">
                                                        <img class="secondary__image" src="{{asset('assets/frontendimg/grid/grid__13.png" alt="Secondary Image">
                                                    </a>
                                                </div>
                                                <div class="grid__wraper__icon">                                
                                                    <ul>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-6">
                                        <div class="grid__wraper">
                                            <div class="grid__wraper__img">
                                                <div class="grid__wraper__img__inner">
                                                    <a href="single-product.html">
                                                        <img class="primary__image" src="{{asset('assets/frontendimg/grid/grid__15.png" alt="Primary Image">
                                                        <img class="secondary__image" src="{{asset('assets/frontendimg/grid/grid__16.png" alt="Secondary Image">
                                                    </a>
                                                </div>
                                                <div class="grid__wraper__icon">                                
                                                    <ul>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-6">
                                        <div class="grid__wraper">
                                            <div class="grid__wraper__img">
                                                <div class="grid__wraper__img__inner">
                                                    <a href="single-product.html">
                                                        <img class="primary__image" src="{{asset('assets/frontendimg/grid/grid__17.png" alt="Primary Image">
                                                        <img class="secondary__image" src="{{asset('assets/frontendimg/grid/grid__18.png" alt="Secondary Image">
                                                    </a>
                                                </div>
                                                <div class="grid__wraper__icon">                                
                                                    <ul>
