...
<div class="single__product sptop50 spbottom__80">
    <div class="container">
        <div class="row">
            <!-- Product Image -->
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="single__product__wraper">
                    ...
                    <div class="single__productspecial__feature mb-3">
                        <ul>
                    ...
                    <div class="single__productbottom__menu">
                        <ul>
        ...
        <div class="single__productspbottom__80">
            <div class="container">
                <div class="row gy-5">
                    <div class="col-xl-6">
